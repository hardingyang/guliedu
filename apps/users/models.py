...
class UserProfile(AbstractUser):
    image=models.ImageField(upload_to='user/',verbose_name='用户头像',max_length=200,null=True,blank=True)
    ...
    gender=models.CharField(verbose_name='性别',choices=(('girl','女'),('boy','男')),max_length=20,default='girl')
