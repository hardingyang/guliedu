...
#用户消息表
class Usermesseage(models.Model):
    messeage_man=models.IntegerField(default=0,verbose_name='消息用户')
    messeage_content=models.CharField(max_length=200,verbose_name='消息内容')
    messeage_status=models.BooleanField(default=False,verbose_name='消息状态')
    add_time = models.DateTimeField(default=datetime.now, verbose_name='评论时间')

    def __str__(self):
        return self.messeage_content
